...
const MEMBERHUB_SCENARIO: DemoScenario = {
  id: "membership-retention-review",
  title: "Membership Retention Review",
  estimatedMinutes: 2,
  description:
    "Show how MemberHub helps a nonprofit review membership health, inspect a member profile, and manage renewal follow-through before retention slips.",
  steps: [
    {
      id: "dashboard-overview",
      title: "Start with the membership overview",
      body:
        "The dashboard shows core member activity, upcoming renewals, payments, and retention risk so staff can spot pressure early.",
      whyItMatters:
        "Membership nonprofits need immediate visibility into renewals and retention, not just a member directory.",
    ...
    {
      id: "renewal-risk",
      title: "Check renewal risk and upcoming renewals",
      body:
        "This section highlights members who may lapse soon and surfaces who needs outreach before renewal dates pass.",
      whyItMatters:
        "This is one of the clearest proof points that the app supports retention operations, not just record keeping.",
      routePrefix: "/dashboard",
      target: "[data-demo='renewal-risk']",
    },
    {
      id: "members-list",
      title: "Open the member roster",
      body:
        "The members workspace helps staff search, filter, and review the active roster before drilling into an individual relationship.",
      whyItMatters:
        "This is where the team moves from portfolio-level retention insight into specific member action.",
      routePrefix: "/members",
      target: "[data-demo='members-table']",
      actionLabel: "Open members",
    },
    {
      id: "member-detail",
      title: "Review a single member profile",
      body:
        "A member profile brings together status, tier, history, and supporting tabs so staff can see everything tied to that relationship.",
      whyItMatters:
        "This is where the system proves it can support real member stewardship, not just a spreadsheet-style roster.",
      routePrefix: "/members/",
      target: "[data-demo='member-detail']",
      actionTarget: "[data-demo='primary-member-row']",
    },
    {
      id: "renewals-workspace",
      title: "Finish in the renewals workspace",
      body:
        "The renewals view gives staff a focused place to work renewal status, track progress, and manage outreach follow-through.",
      whyItMatters:
        "This closes the loop from retention signals to the actual work of keeping members active.",
      routePrefix: "/renewals",
      target: "[data-demo='renewals-workspace']",
